...
void runTimer0AsPeriodic(uint32_t clks) {
    ...
    TimerLoadSet(TIMER0_BASE, TIMER_A, clks); //secs*BASE_CLK
...
int main(void)
{
   ...
   //
                       ...
                       HIBERNATE_INT_GPIO_WAKE | HIBERNATE_INT_RESET_WAKE)))
    {
        ...
        g_ui32HourIdx = 11;
        g_ui32MinIdx = 33;
        strcpy(g_pcMonBuf, "MAR");
        strcpy(g_pcDayBuf, "29");
        strcpy(g_pcYearBuf, "2017");
        strcpy(g_pcHourBuf, "11");
        strcpy(g_pcMinBuf, "33");
        strcpy(g_pcAMPMBuf, "AM");
    }
