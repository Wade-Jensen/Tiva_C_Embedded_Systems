...
build-1062271841:
	@$(MAKE) -Onone -f subdir_rules.mk build-1062271841-inproc

build-1062271841-inproc: ../mutex.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1062271841 ../mutex.cfg
configPkg/compiler.opt: build-1062271841
configPkg/: build-1062271841
