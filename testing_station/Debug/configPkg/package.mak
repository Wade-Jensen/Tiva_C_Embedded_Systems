...
.dlls,em4f .dlls: testing_station.pem4f

-include package/cfg/testing_station_pem4f.mak
-include package/cfg/testing_station_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/testing_station_pem4f.dep
endif
testing_station.pem4f: package/cfg/testing_station_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
testing_station.pem4f package/cfg/testing_station_pem4f.c: .libraries,em4f
endif

package/cfg/testing_station_pem4f.c package/cfg/testing_station_pem4f.h package/cfg/testing_station_pem4f.xdl: override _PROG_NAME := testing_station.xem4f
package/cfg/testing_station_pem4f.c: package/cfg/testing_station_pem4f.cfg
package/cfg/testing_station_pem4f.xdc.inc: package/cfg/testing_station_pem4f.xdl
package/cfg/testing_station_pem4f.xdl package/cfg/testing_station_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/testing_station_pem4f.cfg
	-$(RM) package/cfg/testing_station_pem4f.dep
	-$(RM) package/cfg/testing_station_pem4f.c
	-$(RM) package/cfg/testing_station_pem4f.xdc.inc

clean,em4f::
	-$(RM) testing_station.pem4f
.executables,em4f .executables: testing_station.xem4f

testing_station.xem4f: |testing_station.pem4f

-include package/cfg/testing_station.xem4f.mak
testing_station.xem4f: package/cfg/testing_station_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/testing_station_pem4f.oem4f   package/cfg/testing_station_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
testing_station.xem4f: export C_DIR=
testing_station.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
testing_station.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

testing_station.test test,em4f test: testing_station.xem4f.test

testing_station.xem4f.test:: testing_station.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 testing_station.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.testing_station.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,testing_station.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) testing_station.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
testing_station_pem4f.oem4f,copy : package/cfg/testing_station_pem4f.oem4f
testing_station_pem4f.sem4f,copy : package/cfg/testing_station_pem4f.sem4f
