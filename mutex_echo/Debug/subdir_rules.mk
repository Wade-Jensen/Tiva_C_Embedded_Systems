...
build-1725532303:
	@$(MAKE) -Onone -f subdir_rules.mk build-1725532303-inproc

build-1725532303-inproc: ../mutex.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1725532303 ../mutex.cfg
configPkg/compiler.opt: build-1725532303
configPkg/: build-1725532303
